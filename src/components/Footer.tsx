        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="flex items-center mb-6 md:mb-0">
            <div className="relative group mr-3">
              ...
              <Shield className="h-8 w-8 text-india-saffron relative z-10 group-hover:scale-110 transition-transform" />
            </div>
            <div>
          ...
          <div className="text-center md:text-right">
            <div className="flex items-center justify-center md:justify-end space-x-1 mb-2">
              <span className="w-3 h-3 bg-india-saffron rounded-full pulse-alert"></span>
              <span className="w-3 h-3 bg-white rounded-full"></span>
              <span className="w-3 h-3 bg-india-green rounded-full pulse-alert"></span>
            </div>
        ...
        <div className="py-6 my-6 border-t border-b border-white/10">
          <div className="flex flex-col items-center">
            ...
            <div className="animated-border">
              <div className="bg-gradient-to-r from-india-navyBlue/60 to-india-navyBlue p-6 rounded-lg shadow-xl hover:shadow-india-saffron/20 transition-all duration-300 max-w-md transform hover:-translate-y-1">
