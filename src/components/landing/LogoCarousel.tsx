...
const LogoCarousel = () => {
  ...
  return (
    <div className="py-8 md:py-12 bg-white border-t border-gray-100">
      <div className="container mx-auto px-4">
        ...
        <Carousel
          ...
          className="w-full max-w-[90%] sm:max-w-2xl md:max-w-4xl mx-auto"
        >
          <CarouselContent>
              ...
              <CarouselItem key={index} className="basis-1/2 sm:basis-1/3 md:basis-1/4 flex justify-center">
                <div className="p-1 h-full">
                  <Card className="border-none shadow-none">
                    <CardContent className="flex items-center justify-center p-4 md:p-6 h-full">
                      <img 
                        src={logo.src} 
                        alt={logo.alt} 
