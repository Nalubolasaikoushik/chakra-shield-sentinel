...
import { Shield, Github, Linkedin, Globe, Mail, Code, BadgeCheck, Rocket } from 'lucide-react';
          ...
          <div className="container mx-auto px-4">
            <div className="mt-8 text-center">
              <div className="bg-gradient-to-r from-india-navyBlue to-india-accent3 rounded-xl shadow-xl p-8 text-white">
                ...
                <h2 className="text-2xl md:text-3xl font-bold mb-4">Secure Your Online Presence</h2>
                <p className="text-white/80 max-w-2xl mx-auto mb-8">
                  Join ChakraShield to protect yourself and your community from fake accounts and online fraud.
                </p>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-6 fade-in">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto text-sm md:text-base">
                ChakraShield is developed and maintained by a passionate developer committed to digital security and innovation.
              </p>
            </div>
              ...
              <div className="developer-card bg-white rounded-xl p-4 md:p-6 shadow-lg">
                <div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-6">
                  ...
                  <div className="text-center md:text-left flex-1">
                    ...
                    <p className="text-india-accent3 mb-2 font-medium text-sm">Developer | Tech Enthusiast</p>
                    <p className="text-gray-700 mb-3 text-sm">
                      Computer Science & Engineering student specializing in software development, 
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
                      <div className="flex items-center mb-2">
                        <div className="p-1.5 bg-india-saffron/10 rounded-md mr-2">
                          <Code className="h-4 w-4 md:h-5 md:w-5 text-india-saffron" />
                        </div>
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
                      <div className="flex items-center mb-2">
                        <div className="p-1.5 bg-india-navyBlue/10 rounded-md mr-2">
                          <Shield className="h-4 w-4 md:h-5 md:w-5 text-india-navyBlue" />
                        </div>
                        <h4 className="font-semibold text-india-navyBlue text-sm">Focus Areas</h4>
                      </div>
                      <ul className="space-y-1 text-gray-600 text-xs">
                        <li className="flex items-center">
